...
class DataTransformationConfig:
    ...
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.transformed_object_file_path: str = os.path.join(self.data_transformation_dir,
            ...
            training_pipeline.PREPROCESING_OBJECT_FILE_NAME,)
...
class ModelTrainerConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.overfit_underfit_threshold: float = training_pipeline.MODEL_TRAINER_OVER_FITTING_UNDERFITTING_THRESHOLD
...
class ModelPusherConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        self.model_pusher_dir:str = os.path.join(
            ...
            training_pipeline.MODEL_PUSHER_DIR
        )
